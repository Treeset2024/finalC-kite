...
import { View, Text, StyleSheet, TouchableOpacity, Image, SafeAreaView, ScrollView, Dimensions, Animated} from 'react-native';
...
const modules = [
  ...
  },
  {
    ...
    subModuleName: ['Communication-Skills', 'Teamwork-Collaboration', 'Adaptability-Flexibility', 'Leadership-Motivation', 'Problem-Solving', 'Critical-Thinking', 'Work-Ethics', 'Emotional-Intelligence', 'Creativity']
  },
  {
    name: 'Technical',
    image: require('../assets/images/tec.jpg'),
    subModuleName: ['C-programming', 'Java ', 'Java-Script', 'Python']
  },
  {
  ...
  },
  {
    ...
    subModuleName: ['Quality-Engineering', 'Project-Evaluation', 'Software-Engineering', 'Agile-Development']
  },
  {
    name: 'C_Assessment',
              ...
              {modules.map((module, index) => (
                ...
                onPress={() => {
                  if (module.name === 'C_Assessment') {
                    // alert('Access to C_Assessment is restricted.');
