...
const DATA = [
  ...
  { id: '2', number: '2', title: 'Soft Skills', submodules: ['Communication Skill', 'Teamwork & Collaboration', 'Time & Conflict Management', 'Adaptability & Flexibility', 'Leadership & Motivation', 'Problem Solving', 'Critical Thinking', 'Work Ethics', 'Emotional Intelligence', 'Creativity'] },
  { id: '3', number: '3', title: 'Technical', submodules: ['C programming language', 'Java ', 'JavaScript', 'Python'] },
  { id: '4', number: '4', title: 'Industry_Expertise', submodules: ['Quality Engineering', 'Project Evaluation', 'Software Engineering', 'Agile Development'] },
  { id: '5', number: '5', title: 'C_Qualify', submodules: ['C_Qualify 1',' C_Qualify 2', 'C_Qualify 3'] },
];
    ...
    <Animated.View style={[styles.cardWrapper, { transform: [{ scale: scaleValue }] }]}>
      <TouchableOpacity
        ...
        onPress={() => {
          ...
          navigation.navigate('Detail', { submodules: item.submodules, title: item.title });
        }}
